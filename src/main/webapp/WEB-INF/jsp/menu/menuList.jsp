...
function regPopup(){
	...
	$("#menuPop").modalWindow('${context}/menu/menuInfoRegPopup.do', {reqData : params});
}
	...
	if( cellIndex == 3 ){
		...
		if( recode['childCount'] != 0 ){
			...
			if(confirm("삭제하시겠습니까?")){
				$.ajax({
					type			: "post",
					url				: "${context}/menu/menuInfoDelete.json",
					data			:{
						method : "delete",
...
<div id="wrap">
	<%@ include file="../common/menu.jsp"%>
		...
		<div id="content">
			...
			<div class="content_header">
				...
				<ul class="breadcrumb">
					<li><a href="/">관리자</a></li>
					<li><a href="/menu/programList">메뉴 관리</a></li>
					<li class="active">메뉴 관리</li>
				</ul>
				<!--// Breadcrumb -->

				<h1 class="currentPage">메뉴 관리</h1>
			</div>
			<!--// Content Header -->
	...
	<!--// Footer Wrap -->
	<div id="menuPop" class="lp_wrap lp_memberInfo lp_w600"></div>
</div>
</body>
</html>
...
//	$("a[href='"+G.baseUrl+"']").click(function(e){
//		G.menuMng.removeCookie();
//	});

	$(document).mouseup(function(e) {
		var target = $(e.target);
		if (target.parents('.bootstrap-datetimepicker-widget').length < 1
			&& !target.hasClass('datetimepickerInput')
			&& !target.hasClass('datepickerIcon')
			&& !target.hasClass('clockpickerIcon'))
		{
			$('.datetimepicker').not(target).each(function (index) {
				$(this).data('DateTimePicker').hide();
			});
		}
	});

	$('.datetimepicker').focusin(function(e) {
		var target = $(e.target);
		$('.datetimepicker').not(target).each(function (index) {
			$(this).data('DateTimePicker').hide();
		});
...
//
//			if(options.gifName){
//				gifName = options.gifName;
//			} else {
//				gifName = "loading-spinner-grey.gif";
//			}
//
//			var html = '';
//			if (options.animate) {
...
//				html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img src="' + G.baseUrl + 'images/plugins/theme/' + gifName + '" align=""></div>';
//			} else if (options.textOnly) {
//				html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
//			} else {
//				html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img src="' + G.baseUrl + 'images/plugins/theme/' + gifName + '" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
//			}
//
//			var $el = $(this);
//
